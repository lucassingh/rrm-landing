...
import { Box, Typography, Button, Grid, useTheme, alpha, Container, useMediaQuery } from "@mui/material";
...
export const AUEArgentina: React.FC = () => {
  ...
  const handleDownloadCatalog = () => {
    window.open(
      "https://es.etnopedia.org/wiki/index.php/Cat%C3%A1logos_de_Etnias_No_Alcanzadas_para_la_Iglesia_Iberoamericana",
      "_blank",
      "noopener,noreferrer"
    );
  };
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <img
                      src="/assets/programs/Google_Play_Store_badge_IT.svg%201.png"
                      alt="Google Play"
                      style={{
                        width: "85%",
                        height: "100%",
            ...
            <Grid size={{ xs: 12, md: 6 }} sx={{ paddingBottom: "30px" }}>
              <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}>
                ...
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="/assets/programs/mockup.png"
                    alt="AUE App Mockup"
                    style={{
                      width: "50%",
                      height: "auto",
