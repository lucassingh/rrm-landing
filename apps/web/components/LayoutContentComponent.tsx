    ...
    return (
      ...
      >
        <Grid
          ...
          sx={{
            height: "100%",
            flexDirection: reverseOnMobile ? { xs: "column-reverse", md: "row" } : "row",
          }}
        >
          <Grid size={{ xs: 12, md: 6 }} sx={{ backgroundColor: backgroundColors.left }}>
            <Container
              sx={{
                height: "100%",
                display: "flex",
          ...
          <Grid size={{ xs: 12, md: 6 }} sx={{ backgroundColor: backgroundColors.right }}>
            <Container
              sx={{
                height: "100%",
                display: "flex",
