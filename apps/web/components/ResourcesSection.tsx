...
import { Box, Typography, Accordion, AccordionSummary, AccordionDetails, Button, useTheme, alpha, Container } from "@mui/material";
            ...
            <Box sx={{ maxWidth: 800, mx: "auto" }}>
              {resources.map((resource) => (
                ...
                >
                  <AccordionSummary
                    expandIcon={
                      <motion.div animate={{ rotate: expanded === resource.id ? 180 : 0 }} transition={{ duration: 0.3 }}>
                        <ExpandMoreIcon
                          sx={{
