...
const QRSection = () => {
  ...
  // Derived directly from theme during render (rather than mirrored into state
  // via an effect, as the original source did) — same value, but avoids a
  // one-render-late flash of light-mode colors on first mount in dark mode.
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {isMobile ? t("qrsections.titlemobile") : t("qrsections.subtitle")}
          </Typography>
        </Box>
