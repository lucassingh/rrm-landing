...
export function NavBarComponent() {
  ...
  const handleCardHover = (index: number | null) => setHoveredItem(index);
  ...
  const handleNavigateMenu = () => router.push("/");
  ...
  const desktopNavbar = (
    <Box sx={{ position: "relative", display: "flex", justifyContent: "center" }}>
      ...
      >
        ...
        >
          <Box
            sx={{ display: "flex", gap: 1, flex: 1, marginLeft: "21px", justifyContent: "flex-start" }}
            ...
            <Button
              sx={{
                ...
                "&::before": {
                  ...
                  height: "2px",
                  backgroundColor:
                    mode === "dark" ? theme.palette.primary.contrastText : theme.palette.primary.main,
                  transition: "all 0.3s ease",
                  transform: "translateX(-50%)",
                },
                "&:hover": {
          ...
          <Box
            component={Link}
            href="/"
            sx={{ flex: 1, display: "flex", justifyContent: "center", textDecoration: "none" }}
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/assets/rmm-logo.svg" alt="Logo" width="60px" />
          </Box>
              ...
              >
                <CustomCard
                  sx={{
                    ...
                    "&:hover": { transform: "translateY(-4px)", boxShadow: 4, opacity: 1 },
                  }}
                >
                  <CardActionArea
                    component={Link}
      ...
      <Box sx={{ px: 2 }}>
        <Toolbar sx={{ justifyContent: "space-between", px: 0 }}>
          <Box component={Link} href="/" sx={{ textDecoration: "none" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/assets/rmm-logo.svg" alt="Logo" width="50px" />
          </Box>
          ...
          <IconButton
            ...
            sx={{
              ...
              "&:hover": {
                backgroundColor:
                  mode === "dark" ? alpha(theme.palette.primary.contrastText, 0.8) : alpha("#fff", 0.8),
              },
            }}
          >
      ...
      >
        <Box sx={{ p: 2, height: "100%", display: "flex", flexDirection: "column" }}>
            ...
            {mainMenuItems.map((item, index) => (
              <Box key={index}>
                <ListItem disablePadding>
                  <ListItemButton component={Link} href={item.path} onClick={handleDrawerToggle} sx={{ py: 0 }}>
          ...
          <Box sx={{ display: "flex", gap: 2, justifyContent: "center", py: 6 }}>
            <Button onClick={toggleLanguage} variant="outlined" fullWidth sx={{ borderRadius: 10, py: 1.5 }}>
              {language === "es" ? t("navbar.spanish") : t("navbar.english")}
            </Button>
            <Button onClick={toggleTheme} variant="outlined" fullWidth sx={{ borderRadius: 10, py: 1.5 }}>
              {mode === "dark" ? t("navbar.lightMode") : t("navbar.darkMode")}
            </Button>
          </Box>
        </Box>
