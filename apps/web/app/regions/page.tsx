...
import { ARMapComponent } from "@/components/regions/ARMapComponent";
import BossesCardsComponent from "@/components/BossesCardsComponent";

const regionsBG = '/assets/bgs/regions-bg.jpg';
const mapARes = '/assets/regions/mapARes.png';
const mapARen = '/assets/regions/mapARen.png';
...
export default function RegionsPage() {
    ...
    const getRandomPositionNearRegion = (region: Region) => {
        ...
        region.provinces.forEach(provinceId => {
            ...
            if (element && typeof (element as unknown as SVGGraphicsElement).getBBox === 'function') {
                validElements.push(element as unknown as SVGGraphicsElement);
            }
        });
