...
import { Typography, Box, Container, useMediaQuery, useTheme, styled } from "@mui/material";
...
import { LayoutContentComponent } from "@/components/LayoutContentComponent";
import { RevealFromLeft, RevealFromRight } from "@/components/RevealAnimation";
...
// Hoisted out of HomePage (rather than defined per-render like the original
// Vite source) to satisfy the "no components created during render" rule —
// the responsive height that used to depend on the component's `isMobile`
// boolean is expressed as an equivalent theme breakpoint instead, so the
// rendered result (250px below md, 500px at md+) is unchanged.
    ...
    <>
      ...
      >
        <Box
          ...
          playsInline
          preload="auto"
          src="/assets/videos/video_bg.mp4"
          sx={{
            position: "absolute",
            top: "50%",
            left: "50%",
      ...
      >
        <RevealFromLeft>
          <Box padding={{ xs: "16px 0", md: "16%" }}>
            ...
            <Typography variant="h3" component="h3" gutterBottom sx={{ textAlign: "left", mb: 4 }}>
        ...
        <RevealFromRight>
          <ParallaxImage src="/assets/mvv/mision.jpg" alt="mision image" />
        </RevealFromRight>
      </LayoutContentComponent>
      ...
      >
        <RevealFromLeft>
          <ParallaxImage src="/assets/mvv/vision.jpg" alt="vision image" />
        </RevealFromLeft>
        <RevealFromRight>
          <Box padding={{ xs: "16px 0", md: "16%" }}>
            <Typography
      ...
      >
        ...
        <RevealFromRight>
          <ParallaxImage src="/assets/mvv/values.jpg" alt="values image" />
        </RevealFromRight>
      </LayoutContentComponent>

      {i18n.language === "es" ? (
        <LayoutContentComponent layoutType="full" backgroundColor="inherit" height={"auto"}>
          <Box
            sx={{
              maxWidth: 1200,
              margin: "0 auto",
          ...
          >
            <HeaderComponent title={t("whatdo.title")} subtitle={t("whatdo.subtitle")} align="center" sx={{ marginBottom: 6 }} />
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      que abarcan todo el país. Te invitamos a participar en tu región poniéndote en contacto con su
                      representante. Haciendo click aquí accedes a la información de las regiones y los datos de
                      contacto.
                    </Typography>
                  </Box>
                  {!isMobile && (
                    ...
                    >
                      ...
                      <img width="100%" height="auto" src="/assets/whatdo/img_1.jpg" alt="" />
                    </Box>
                  )}
                </Box>
              </RevealFromLeft>
                ...
                <RevealFromRight>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          , que sirven en diferentes áreas de la misión. Contactate con los coordinadores de cada
                          foro para colaborar y participar.
                        </Typography>
                      </Box>
                    </Box>
                    ...
                    >
                      ...
                      >
                        También la RMM está formada por Agencias Misioneras, Centros de Capacitación, Movilización e
                        Iglesias comprometidas con la visión de alcanzar a los no alcanzados. Conocé las{" "}
                        <Link
                          href="/entities"
                          style={{
                            color: "#1976d2",
                  ...
                  <RevealFromRight>
                    ...
                    >
                      ...
                      >
                        ...
                        , que sirven en diferentes áreas de la misión. Contactate con los coordinadores de cada foro
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      that cover the entire country. We invite you to participate in your region by contacting its
                      representative. Click here to access information about the regions and contact details.
                    </Typography>
                  </Box>
                  {!isMobile && (
                    <Box
                ...
                <RevealFromRight>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          , which serve in different areas of mission. Contact the coordinators of each forum to
                    ...
                    >
                      ...
                      >
                        The RMM is also formed by Mission Agencies, Training Centers, Mobilization and Churches
                        committed to the vision of reaching the unreached. Discover the{" "}
                        <Link
                          href="/entities"
                          style={{
                            color: "#1976d2",
